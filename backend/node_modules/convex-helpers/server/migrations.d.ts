 ...
 */
import { DocumentByInfo, DocumentByName, FunctionReference, GenericDatabaseReader, GenericDataModel, GenericMutationCtx, MutationBuilder, NamedTableInfo, RegisteredMutation, Scheduler, TableNamesInDataModel } from "convex/server";
...
}): <TableName extends TableNamesInDataModel<DataModel>>({ table, migrateOne, batchSize: functionDefaultBatchSize, }: {
    table: TableName;
